...
| :--- | :--- | :--- |
| Fabio Contreras | Líder (Arquitecto) | [@fabio-contreras](https://github.com/fabio-contreras) |
| Juan Esteban Osorio Arevalo | Desarrollador | [@JuanOsorio323](https://github.com/JuanOsorio323) |
| Johan Gomez | Desarrollador | [@JohanGomez-8bits](https://github.com/JohanGomez-8bits) |
...
* **Reuniones de Sincronización (Daily Stand-up):** Nos reuniremos los días **jueves y sábados** a las **12:00 PM** de forma **presencial**.
* **Tiempo máximo de respuesta:** Nos comprometemos a responder mensajes del equipo en un máximo de **6 horas** durante el horario hábil.
...
* **Ausencias:** Si alguien no puede trabajar por fuerza mayor, debe avisar por el canal oficial con al menos **12 horas** de anticipación para reasignar sus tareas.
